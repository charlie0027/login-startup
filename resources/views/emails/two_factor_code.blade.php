    ...
    <div class="body-div">
        <div class="card">
            ...
            <div style="text-align: center">
                <h2>
                    <center>TWO FACTOR AUTHENTICATION CODE 👀</center>
                </h2>

            </div>
            <div class="container">
                <h3 class="email-salutation">Hello!</h3>
                <div class="email-content-div">
                    <p class="email-content">
                        Your two factor code is: <span style="font-weight: bold">{{ $code }}</span>
                    </p>

                    {{-- <center><a href="{{ $url }}" class="buttonLink">Verify Email</a></center>
